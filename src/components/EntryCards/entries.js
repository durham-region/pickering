...
export const entries = [
  ...
  },
  {
    ...
    description:
      "This page contains most activities coordinated by the City of Pickering, it is an excelente resource. You can search for activities for: toddler and parents, swimming, gardening, sports, etc",
    phone: null,
  ...
  },
  {
    ...
    description:
      "This page contains activities coordinated by the Town of Ajax. Highlighs: Sportball, Swim Parent & Tot",
    phone: null,
  ...
  },
  {
    name: "Pamela Yool",
    description:
      "Professional photographer based in Pickering specializing in newborn, toddler (6 months & 1 year), and family fine art portraits.",
    phone: null,
